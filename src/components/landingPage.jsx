...
import crazyStars1 from "./particlesSugarMap";
            ...
            <Cell col={10} className="social-links fade-in">
              ...
              <svg width="54px" height="54px" viewBox="0 0 128 128">
                ...
                <path
                  ...
                  strokeMiterlimit="10"
                  fill="white"
                  d="M88.41,64A7.92,7.92,0,0,1,80.67,71c-6.16.31-9.05-3.78-9.51-8.5A13.62,13.62,0,0,1,72.36,55a8.37,8.37,0,0,1,8.71-4.67,8,8,0,0,1,7.1,6.09,41.09,41.09,0,0,1,.69,4.5H72.67c-.3,4.28,2,7.72,5.26,8.55,4.06,1,7.53-.76,8.79-4.62C87,63.86,87.51,63.72,88.41,64ZM72.67,59.55H87.14c-.09-4.56-2.93-7.86-6.78-7.91C76,51.57,72.86,54.75,72.67,59.55Z"
                />
                <path
                  className="path"
                  stroke="#000000"
                ...
                <path
                  ...
                  strokeMiterlimit="10"
                  fill="white"
                  d="M38.1,70.51a2.29,2.29,0,0,1-2.84-1.08c-1.63-2.44-3.43-4.77-5.16-7.15l-.75-1c-2.06,2.76-4.12,5.41-6,8.16a2.2,2.2,0,0,1-2.7,1.06l7.73-10.37-7.19-9.37a2.39,2.39,0,0,1,2.85,1c1.67,2.44,3.52,4.77,5.36,7.24,1.85-2.45,3.68-4.79,5.39-7.21a2.15,2.15,0,0,1,2.68-1l-2.79,3.7c-1.25,1.65-2.48,3.31-3.78,4.92a1,1,0,0,0,0,1.49C33.29,64.07,35.66,67.25,38.1,70.51Z"
                />
                <path
                  className="path"
                  stroke="#000000"
          ...
          <Grid>
            ...
            <Cell className="typewriter" col={10}>
              <Grid>
                ...
                <Cell col={10}>
                  <div className="typewriter-text">
                    FRONT-END: REACT | GOOGLE MAPS API | FRONT10 |
                    SEMANTIC-UI-REACT | ANIMATE-CSS
                  </div>
                </Cell>
                <Cell col={1} />
              </Grid>
              <Grid>
                ...
                <Cell col={10}>
                  <div className="typewriter-text">
                    BACK-END: EXPRESS | NODE-JS | DOCKER
                  </div>
                </Cell>
                <Cell col={1} />
              </Grid>
              <Grid>
                ...
                <Cell col={10}>
                  <div className="typewriter-text">
                    DEPLOYMENT: GOOGLE KUBERNETES ENGINE | GOOGLE CLOUD PLATFORM | BLUEHOST
                  </div>
                </Cell>
                <Cell col={1} />
              </Grid>
